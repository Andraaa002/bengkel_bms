...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        ...
        // Cek apakah username sudah ada di tabel karyawan
        ...
        if (empty($username_err) && $stmt = mysqli_prepare($conn, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                if (mysqli_stmt_num_rows($stmt) == 1) {
                    $username_err = "Username ini sudah digunakan oleh manajer.";
                }
            }
    ...
    if (empty($username_err) && empty($password_err) && empty($nama_err)) {
        ...
        // Buat query untuk memasukkan karyawan baru
        $sql = "INSERT INTO karyawan (username, password, nama, created_at, updated_at) VALUES (?, ?, ?, NOW(), NOW())";
        ...
        if ($stmt = mysqli_prepare($conn, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                ...
                $_SESSION['message'] = "Karyawan baru berhasil ditambahkan!";
...
<head>
  ...
  <title>Tambah Karyawan - BMS Bengkel</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="topbar">
      <div class="d-flex align-items-center">
        ...
        <h1 class="page-title ms-3">Tambah Karyawan</h1>
      </div>
    </div>
            ...
            <div class="card-body">
              <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group text-end mt-4">
                  <a href="pengguna.php" class="btn btn-secondary me-2">
