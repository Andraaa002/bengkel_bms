...
<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar-content px-4 py-3">
        ...
        <div class="nav-menu">
            ...
            <a href="manajer_pengeluaran.php" class="nav-link <?= ($currentPage == 'manajer_pengeluaran.php') ? 'active' : '' ?>">
                <div class="nav-link-icon">
                    <i class="fas fa-wallet"></i>
                </div>
                <span>Kasbon Manajer</span>
            </a>

            <a href="riwayat_transaksi.php" class="nav-link <?= ($currentPage == 'riwayat_transaksi.php') ? 'active' : '' ?>">
                <div class="nav-link-icon">
            ...
            <!-- New Menu Item: History Pengeluaran for Admin -->
            <a href="history_pengeluaran.php" class="nav-link <?= ($currentPage == 'history_pengeluaran.php') ? 'active' : '' ?>">
                <div class="nav-link-icon">
...
<style>
    ...
    /* Logo styling - Purple theme for admin */
    .logo-circle {
    ...
    /* Divider - Purple theme for admin */
    .sidebar-divider {
        height: 1px;
    ...
    /* Navigation links - Purple theme for admin */
    .nav-menu {
        display: flex;
    ...
    /* Mobile toggle button - Purple theme for admin */
    .mobile-nav-toggle {
        display: none;
        position: fixed;
        top: 15px;
